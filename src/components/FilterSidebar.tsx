...
export default function FilterSidebar({ filters, onFilterChange, totalItems }: FilterSidebarProps) {
  ...
  return (
    <aside 
      className="bg-md-sys-surface-container rounded-xl shadow-md border border-md-sys-outline-variant p-6 h-fit sticky top-8"
      role="region"
      aria-labelledby="filters-heading"
    >
      <header className="flex items-center justify-between mb-6">
        <h2 id="filters-heading" className="text-md-title-large font-medium text-md-sys-on-surface">Filters</h2>
        {hasActiveFilters && (
          <button
            onClick={clearFilters}
            className="flex items-center gap-2 px-3 py-2 bg-md-sys-error-container text-md-sys-on-error-container rounded-xl hover:bg-md-sys-error-container/90 transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-md-sys-error/20 shadow-sm hover:shadow-md border border-md-sys-error/20"
          >
      ...
      <form className="space-y-6" role="search" aria-label="Filter car listings">
        {/* Results Count */}
        <div className="bg-md-sys-primary-container text-md-sys-on-primary-container px-4 py-3 rounded-xl border border-md-sys-primary/20">
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
            <div>
              <div className="text-md-title-small font-medium">
                {totalItems.toLocaleString()}
              </div>
              <div className="text-md-body-small opacity-80">
        ...
        <fieldset>
          ...
          <div className="space-y-2">
            <Tooltip content="Filter to display only vehicles that have modifications">
              <label 
                className="flex items-center space-x-3 cursor-pointer group p-3 rounded-xl hover:bg-md-sys-surface-container/50 transition-all duration-200"
              ...
              >
                <input
                  ...
                  className="rounded border-md-sys-outline text-md-sys-primary focus:ring-2 focus:ring-md-sys-primary/20 focus:border-md-sys-primary transition-colors duration-200 cursor-pointer w-5 h-5"
                />
                <span className="text-md-body-medium font-medium text-md-sys-on-surface group-hover:text-md-sys-primary transition-colors duration-200">
                  Show only modified cars
                </span>
                <HelpCircle className="w-4 h-4 text-md-sys-on-surface-variant" />
              </label>
            </Tooltip>
          </div>
        </fieldset>
        ...
        {/* Make Filter */}
        <fieldset>
          <legend className="flex items-center gap-2 text-md-body-large font-medium text-md-sys-on-surface mb-3">
            <span>Vehicle Make</span>
            <Tooltip content="Select a vehicle manufacturer to filter results. Choosing a make will update available models.">
              <HelpCircle className="w-4 h-4 text-md-sys-on-surface-variant cursor-help" />
            </Tooltip>
          </legend>
          {loading ? (
            <div 
              className="animate-pulse h-12 bg-md-sys-surface-container-high rounded-xl"
              role="status"
        ...
        <fieldset>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-md-sys-outline rounded-xl bg-md-sys-surface text-md-sys-on-surface focus:border-md-sys-primary focus:ring-2 focus:ring-md-sys-primary/20 focus:outline-none transition-all duration-200 text-md-body-medium disabled:bg-md-sys-surface-container-low disabled:text-md-sys-on-surface/38 disabled:cursor-not-allowed hover:bg-md-sys-surface-container/50 disabled:hover:bg-md-sys-surface-container-low"
          >
            ...
            {PRICE_RANGES.map((range, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-4 py-4 rounded-xl text-md-body-medium font-medium transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-md-sys-primary/20 focus-visible:ring-2 focus-visible:ring-md-sys-primary shadow-sm hover:shadow-md border ${
                    isSelected
        ...
        <fieldset>
          <legend className="flex items-center justify-between text-md-body-large font-medium text-md-sys-on-surface mb-3">
            <div className="flex items-center gap-2">
